  ...
  return (
    <section className="bg-linear-to-b from-white to-gray-200">
      ...
      "
        ...
        <div className="mt-3">
          <Link
            className="rounded-full bg-[#2e8b57] px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-[#236b46]"
            to="/sample-resumes"
          >
            View Resume Samples
          </Link>
      ...
      "
        >
          <span className="rounded bg-emerald-100">✓ ATS Friendly</span>
          <span className="rounded bg-emerald-100">✓ Free PDF Export</span>
          <span className="rounded bg-emerald-100">✓ No Sign Up Required</span>
        </div>
