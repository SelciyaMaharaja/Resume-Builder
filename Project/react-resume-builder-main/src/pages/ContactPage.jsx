      ...
      <div className="max-w-2xl mx-auto bg-white shadow-xl border border-slate-200 rounded-xl p-6 sm:p-10">
        ...
        <div className="mb-8 border-b pb-6">
          ...
          <p className="text-sm text-slate-500 mt-2 leading-relaxed">
            If you have any questions, feedback, or issues, feel free to reach
            out. We're here to help you. Thanks.
          </p>
        </div>
        ...
        <div className="space-y-6">
          {/* EMAIL */}
          <InfoBlock label="Email" value="selciya@gmail.com" highlight />
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-lg p-4">
            <p className="text-sm font-semibold text-slate-900 mb-1">Note</p>

            <p className="text-sm text-slate-600 leading-relaxed">
              This is a free tool, so responses may take a little time. We try
          ...
          <div className="text-center">
            <button className="text-sm bg-indigo-200 px-1">
              <a
                ...
                target="_blank"
                rel="noopener"
                href="https://github.com/selciyamaharaja/buildmyresumestudiomg"
              >
                Visit Github
              </a>
            </button>
...
function InfoBlock({ label, value, highlight }) {
  return (
    <div className="flex items-start justify-between gap-6">
      {/* LABEL */}
      <p className="text-sm font-semibold text-slate-900 min-w-30">{label}</p>
