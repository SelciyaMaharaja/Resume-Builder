    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="sticky top-0 z-10 bg-white/90 backdrop-blur border-b border-gray-200">
        ...
        font-semibold text-gray-900 "
          ...
          uppercase font-medium bg-emerald-100"
              >
                {template.name}
              </h2>
            </div>
            ...
            <div className="flex items-center justify-center sm:justify-end gap-2 sm:gap-3">
              ...
              >
                {({ loading }) => (
                  <button className="bg-[#2e8b57] text-white cursor-pointer text-xs sm:text-sm px-4 sm:px-5 py-2 rounded-md hover:bg-[#236b46] transition w-full sm:w-auto">
